...
require_once EHBP_PLUGIN_DIR . 'includes/admin/class-rewrite-screen.php';
require_once EHBP_PLUGIN_DIR . 'includes/admin/class-neighborhoods-screen.php';
